...
(defn-spec article-list (s/or :ok :api-raml/article-summary-list, :error :api-raml/error)
  ...
  ([content-type-list :api-raml/content-type-list, page pos-int?, per-page pos-int?, order :api-raml/order, api-key string?]
   (lax/article-list {:content-type-list content-type-list
                      :page page
                      :per-page per-page
                      :order order
                      :api-key api-key})))
...
(defn-spec article (s/or :ok :api-raml/article, :error :api-raml/error)
  ...
  ([id :api-raml/manuscript-id, content-type-list :api-raml/content-type-list, api-key string?]
   (lax/article id {:content-type-list content-type-list
                    :api-key api-key})))
...
(defn-spec related-article-list (s/or :ok :api-raml/related-article-list, :error :api-raml/error)
  ...
  ([id :api-raml/manuscript-id, content-type-list :api-raml/content-type-list, api-key string?]
   (lax/related-article-list id {:content-type-list content-type-list
                                 :api-key api-key})))
...
(defn-spec article-version-list (s/or :ok :api-raml/article-version-list, :error :api-raml/error)
  ...
  ([id :api-raml/manuscript-id, content-type-list :api-raml/content-type-list, api-key string?]
   (lax/article-version-list id {:content-type-list content-type-list
                                 :api-key api-key})))
...
(defn-spec article-version (s/or :ok :api-raml/article, :error :api-raml/error)
  ...
  ([id :api-raml/manuscript-id, version pos-int?, content-type-list :api-raml/content-type-list, api-key string?]
   (lax/article-version id version {:content-type-list content-type-list
                                    :api-key api-key})))
